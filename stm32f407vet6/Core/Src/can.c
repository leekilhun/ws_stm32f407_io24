...
void MX_CAN1_Init(void)
{
  ...
  sFilterConfig.FilterScale          = CAN_FILTERSCALE_16BIT; //CAN_STD
  // sFilterConfig.FilterScale       = CAN_FILTERSCALE_32BIT; //CAN_EXT
  ...
  canFilter1.FilterScale          = CAN_FILTERSCALE_16BIT; //CAN_STD
