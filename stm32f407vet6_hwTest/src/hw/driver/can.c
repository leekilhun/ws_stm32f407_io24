...
// cal http://www.bittiming.can-wiki.info/
//stm32f407  APB1  42Mhz
const can_baud_cfg_t can_baud_cfg_42m_normal[] =
    {
        //{28, CAN_SJW_4TQ, CAN_BS1_12TQ, CAN_BS2_2TQ}, // 100K, 87.5%
        //{21, CAN_SJW_4TQ, CAN_BS1_13TQ, CAN_BS2_2TQ}, // 125K, 87.5%
        //{12, CAN_SJW_4TQ, CAN_BS1_11TQ, CAN_BS2_2TQ}, // 250K, 87.5%
        //{6,  CAN_SJW_4TQ, CAN_BS1_11TQ, CAN_BS2_2TQ}, // 500K, 87.5%
        //{3,  CAN_SJW_4TQ, CAN_BS1_11TQ, CAN_BS2_2TQ}, // 1M,   87.5%

        {21, CAN_SJW_1TQ, CAN_BS1_14TQ, CAN_BS2_5TQ}, // 100K, 75.0%
        {21, CAN_SJW_1TQ, CAN_BS1_11TQ, CAN_BS2_4TQ}, // 125K, 75.0%
        {14, CAN_SJW_1TQ, CAN_BS1_8TQ,  CAN_BS2_2TQ}, // 250K, 75.0%
        {7,  CAN_SJW_1TQ, CAN_BS1_8TQ,  CAN_BS2_3TQ}, // 500K, 75.0%
        {2,  CAN_SJW_1TQ, CAN_BS1_15TQ, CAN_BS2_5TQ}, // 1M,   76.2%

    };


// stm32f407 not support FDcan
...
bool canConfigFilter(uint8_t ch, uint8_t index, can_id_type_t id_type, uint32_t id, uint32_t id_mask)
{
  ...
  {
    HAL_CAN_ActivateNotification(&can_tbl[ch].hcan, CAN_IT_RX_FIFO0_MSG_PENDING);
    ret = true;
  }
...
void canRxFifoUpdate(uint8_t ch)
{
  ...
  if (HAL_CAN_GetRxMessage(&can_tbl[ch].hcan, can_tbl[ch].fifo_idx, &rx_header, rx_buf->data) == HAL_OK)
  {
    ...
    rx_buf->length = dlc_len_tbl[(rx_header.DLC) & 0x0F];
...
void HAL_CAN_MspInit(CAN_HandleTypeDef* canHandle)
{
  ...
  if(canHandle->Instance==CAN1)
  {
    ...
    */
    ...
    HAL_NVIC_SetPriority(CAN1_SCE_IRQn, 8, 0);  // status change error interrupt
